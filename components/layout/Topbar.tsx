...
export async function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-40 h-14 flex items-center gap-3 px-4 md:px-6 backdrop-blur-xl" style={{ background: 'rgba(0, 0, 0, 0.3)', borderBottom: '1px solid rgba(255, 255, 255, 0.3)' }}>
